---
title: "Novice: Trochar Motion Analysis"
execute: 
  eval: true
format: 
  html: 
...
p1 <- ggplot(novice_trochar, aes(x = TimeStamp, y = StylusPositionY, color = Assessment_ID)) +
  geom_line() +
  theme_minimal() +
...
p2 <- ggplot(novice_trochar, aes(x = TimeStamp, y = StylusPositionX, color = Assessment_ID)) +
  geom_line() +
  theme_minimal() +
  labs(title = "Time Series of Stylus Positions",
       x = "Timestamp",
...
# Plotting
p3 <- ggplot(novice_trochar, aes(x = TimeStamp, y = StylusPositionZ, color = Assessment_ID)) +
  geom_line() +
  theme_minimal() +
  labs(title = "Time Series of Stylus Positions",
       x = "Timestamp",
...
distance_matrix_novice_trochar = calculate_dtw_distance_xyz(df_pivoted)
...
# Convert to parquet
distance_matrix_novice_trochar.to_parquet('distance_matrix_novice_trochar.parquet')

# Upload the file
s3_client.upload_file('distance_matrix_novice_trochar.parquet', 'vr-sling', 'distance_matrix/XYZ/distance_matrix_novice_trochar.parquet')
...
plot_dtw_distance_matrix(distance_matrix_novice_trochar, 'dtw_novice_trochar_heatmap.png')

```

```{r}

write_csv(novice_trochar, "novice_trochar_ts.csv")
...
distance_array = squareform(distance_matrix_novice_trochar.values, checks=False)
...
dendrogram(Z)
plt.title('Hierarchical Clustering: Novice Trochar')
plt.xlabel('Index of Time Series')
plt.ylabel('Distance')

# Save the plot as an image file
plt.savefig('hierarchical_clustering_novice_trochar.png', dpi=400)
