...
def create_traces_for_all_assessments(df):
    ...
    for aid in df['Assessment_ID'].unique():
        ...
        no_collisions_trace = go.Scatter3d(
            x=filtered_df[filtered_df['Collided'] == False]['HeadPositionX'],
            y=filtered_df[filtered_df['Collided'] == False]['HeadPositionY'],
            z=filtered_df[filtered_df['Collided'] == False]['HeadPositionZ'],
            mode='markers',
            marker=dict(size=2),
        ...
        collisions_trace = go.Scatter3d(
            x=filtered_df[filtered_df['Collided'] == True]['HeadPositionX'],
            y=filtered_df[filtered_df['Collided'] == True]['HeadPositionY'],
            z=filtered_df[filtered_df['Collided'] == True]['HeadPositionZ'],
            mode='markers',
...
layout = go.Layout(
    ...
    scene=dict(
        xaxis_title='Head Position X',
        yaxis_title='Head Position Y',
        zaxis_title='Head Position Z'
    ),
    title=''
)
